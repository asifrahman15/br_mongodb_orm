...
from br_mongodb_orm.utils import bulk_insert
...
```python
from br_mongodb_orm.utils import bulk_delete
...
```python
from br_mongodb_orm.utils import bulk_write
...
```python
from br_mongodb_orm.exceptions import BulkWriteError
...
async def migrate_user_data():
    ...
    # Get all users in old format as
